...
/*exports.getLoginInfo = function(authcode, permanentCode, callback) {
  var url = this.prefix + 'service/get_login_info?provider_access_token=' + this.suiteToken.suite_access_token;
};*/
