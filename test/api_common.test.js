...
describe('api_common.js', function () {
  ...
  describe('getSuiteToken', function () {
    it('should ok', function (done) {
      ...
      api.getSuiteToken(function (err, token) {
    ...
    describe('mock urllib err', function () {
      ...
      it('should get mock error', function (done) {
        var api = new API('appid', 'secret', 'suite_ticket');
        api.getSuiteToken(function (err, token) {
          expect(err).to.be.ok();
  ...
  describe('getLatestToken', function () {
    ...
    it('should get mock error', function (done) {
      var api = new API(config.corpid, config.corpsecret, config.suite_ticket, 1, function (callback) {
